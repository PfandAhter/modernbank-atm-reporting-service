...
import com.modernbank.atm_reporting_service.model.dto.ErrorCodesDTO;
import com.modernbank.atm_reporting_service.websocket.service.interfaces.IErrorCacheService;
...
import com.modernbank.atm_reporting_service.websocket.controller.api.response.ErrorResponse;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ResponseStatus(HttpStatus.NOT_ACCEPTABLE)
    public ResponseEntity<ErrorResponse> handleException(EncryptionException e){
        return ResponseEntity.status(HttpStatus.NOT_ACCEPTABLE).body(createFailResponseBody(e.getMessage(),HttpStatus.NOT_ACCEPTABLE));
    }
    ...
    @ResponseStatus(HttpStatus.NOT_ACCEPTABLE)
    public ResponseEntity<ErrorResponse> handleException(CreateFailedException e){
        return ResponseEntity.status(HttpStatus.NOT_ACCEPTABLE).body(createFailResponseBody(e.getMessage(),HttpStatus.NOT_ACCEPTABLE));
    }
